...
//        {/* project title here */}
//        <div className=''>
//           <h1 className='text-right text-2xl dark:text-slate-100'>Projects</h1>
//        </div>
//        <div className='relative z-10 mt-20 bg-slate-200 pb-10 sm:mt-56 sm:pb-24 lg:px-24'>
//           <div className='absolute inset-0 overflow-hidden' aria-hidden='true'>
//              <div className='absolute left-[calc(50%-19rem)] top-[calc(50%-36rem)] transform-gpu blur-3xl'>
//                 <div
//                    className='aspect-auto w-[68.5625rem] bg-gradient-to-r from-[#d1d0d0] to-[#9a99b7] opacity-25'
...
//                    <img
//                       className='hover:opacity-90 hover:-translate-y-2 transform transition-all duration-300 ease-in-out absolute inset-0 h-full w-full rounded-2xl object-cover shadow-2xl lg:h-[50%] lg:-w-[50%]'
//                       src='https://images.unsplash.com/photo-1517841905240-472988babdf9?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2102&q=80'
//                       alt=''
//                    />
//                 </div>
...
//                 </div> */}
//              </div>
//              <div className='w-full max-w-2xl lg:py-24 lg:px-8 xl:mx-4 xl:px-24 xl:flex-auto'>
//                 <div>
//                    <h3>Project Name</h3>
//                 </div>
//                 {/* tags - map it here */}
