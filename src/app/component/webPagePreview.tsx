...
const WebPagePreview = ({ url }: { url: string }) => {
   return (
      <div className='w-[100px] h-[200px] absolute'>
         <iframe
            src={url}
            title='Webpage Preview'
            className='absolute inset-0 h-full w-full overflow-hidden opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out'
