...
## Objectives
1.	Build a user interface that can track the users's reading time, choice of book, rating their emotion or feel for their book per reading session, and notes that can be connected to users’ reading session. 
...
## Challenges
The scale of the project posed significant challenges. As the application grew larger, the more debugging became increasingly difficult, often leaving me spending hours or even days tr left me hours and days trying to trace where things went wrong.
